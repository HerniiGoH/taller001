...
public class TestPaso03 {
	...
	public void init() {
		...
		l1= new Libro(1, "Libro1", 10.0, 20.0, 154, new Date());
		l2= new Libro(2, "Libro2", 20.0, 24.0, 361, new Date());
		l3= new Libro(3, "Libro3", 15.0, 18.0, 108, new Date());
		l4= new Libro(4, "Libro4", 30.0, 16.0, 250, new Date());
		l5= new Libro(5, "Libro5", 24.0, 32.0, 545, new Date());
		l6= new Libro(6, "Libro6", 28.0, 54.0, 302, new Date());
		v1= new Video(7, "Video7", 28.0, 360, new Date());
		v2= new Video(8, "Video8", 15.0, 625, new Date());
		v3= new Video(9, "Video9", 30.0, 145, new Date());
		v4= new Video(10, "Video10", 45.0, 38, new Date());
		v5= new Video(11, "Video11", 12.0, 60, new Date());
	}
